...
namespace Material.Dialog.Bases {
    internal class DialogWindowBase<TWindow, TResult> : IDialogWindow<TResult>
        ...
        public Task<TResult> Show() {
            return Procedure(delegate { _window.Show(); });
        }
        ...
        /// <returns>Result of dialog.</returns>
        public Task<TResult> Show(Window window) {
            return Procedure(delegate { _window.Show(window); });
        }
        ...
        /// <returns>Result of dialog.</returns>
        public Task<TResult> ShowDialog(Window ownerWindow) {
            return Procedure(delegate { _window.ShowDialog(ownerWindow); });
        }
